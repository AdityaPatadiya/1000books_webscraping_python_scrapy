...
# use to replace only user-agent every time.
class ScrapeOpsFakeUrlAgentMiddleware:
    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)  # it use to access the setting file of the project.
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_user_agent_active = settings.get('SCRAPEOPS_FAKE_USER_AGENT_ENABLED', False)
    ...
    def scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '' or self.scrapeops_fake_user_agent_active == False:
    ...
    def process_request(self, request, spider):
        ...
        print("****** NEW HEADER ATTACHER *******")
        print(request.headers['User-Agent'])


# it will create a new complete header every time.
...
#         self.scrapeops_fake_browser_headers_active = settings.get('SCRAPEOPS_FAKE_BROWSWSER_HEADERS_ENABLED', True)
#         self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
#         self.headers_list = []
...
#
#         print("**************")
#         print(type(random_browser_header))  # print the type of random_browser_header
#         print(random_browser_header)  # print the random_browser_header
#         print("**************")
#
#         if isinstance(random_browser_header, dict):
...
#         else:
#             print("Error: random_browser_header is not a dictionary")
#
#         print("************** NEW HEADER ATTACHED **************")
#         print(request.headers)
